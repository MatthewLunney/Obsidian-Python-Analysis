...
def select_ticker_and_dates(sector):
    ...
    sector_file = os.path.join('data', f"{sector}.xlsx")
...
std_pe = pd['P/E'].std()
ax2.axhline(std_pe, color='blue', linestyle='--', linewidth=1, label='Std Rel P/E')
ax2.axhline(std_pe + std_pe, color='red', linestyle='--', linewidth=1, label='+1 Std Rel P/E')
ax2.axhline(std_pe - std_pe, color='green', linestyle='--', linewidth=1, label='-1 Std Rel P/E')
